...
if ( ! class_exists( 'WordCamp_Talks_Core_Loop' ) ) :
/**
 ...
 * for each object.
 *
 * @see  WordCamp_Talks_Talks_Loop for an example of use.
 *
 * @since 1.0.0
 * @since 1.1.0 Name changed from WordCamp_Talks_Loop to WordCamp_Talks_Core_Loop.
 */
class WordCamp_Talks_Core_Loop {
