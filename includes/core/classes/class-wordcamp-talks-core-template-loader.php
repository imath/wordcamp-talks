...
if ( ! class_exists( 'WordCamp_Talks_Core_Template_Loader' ) ) :
/**
 ...
 *
 * @since 1.0.0
 * @since 1.1.0 Name changed from WordCamp_Talks_Template_Loader to WordCamp_Talks_Core_Template_Loader
 */
class WordCamp_Talks_Core_Template_Loader {
	/**
