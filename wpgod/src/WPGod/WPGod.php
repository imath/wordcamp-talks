...
namespace WPGodWordcamptalks;

use WPGodWordcamptalks\Handler\GodErrorHandler;
use WPGodWordcamptalks\Handler\GodTrackingHandler;
use WPGodWordcamptalks\Handler\GodAdminNoticeHandler;
use WPGodWordcamptalks\Helpers\GodError;
use WPGodWordcamptalks\Helpers\GodServerInfo;
use WPGodWordcamptalks\Helpers\GodEnvironmentInfo;
use WPGodWordcamptalks\Helpers\GodTypeDevelopment;
use WPGodWordcamptalks\Services\GodApi;
use WPGodWordcamptalks\Services\GodFilesRules;
use WPGodWordcamptalks\Services\GodCheckErrors;
use WPGodWordcamptalks\Services\GodAuthorizeError;
...
class WPGod{
    ...
    public function __construct($params){
        ...
        if($missingParameters === 0){
            ...
            $authorizeTracking        = get_option("wpgod_wordcamp-talk_allow_tracking");
