...
namespace WPGodWordcamptalks\Services;

use WPGodWordcamptalks\Models\ServiceInterface;
use WPGodWordcamptalks\WPGod;

class GodApi implements ServiceInterface
{

    public static $NAME_TRANSIENT_OTHER         = "wpgod_583dc366ae705_site";
    
    public static $NAME_TRANSIENT_ALREADY_CHECK = "wpgod_583dc366ae740_already";
    
    public static $LAST_CHECK_TRACKING_GENERAL  = "wpgod_583dc366ae777_tracking_g";
